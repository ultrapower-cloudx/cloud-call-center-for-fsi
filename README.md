...
```bash
git clone git@ssh.gitlab.aws.dev:aws-gcr-solutions/industry-assets/fsi/cloud-call-center-for-fsi.git
```
...
```
cd existing_repo
git remote add origin https://gitlab.aws.dev/aws-gcr-solutions/industry-assets/fsi/cloud-call-center-for-fsi.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.aws.dev/aws-gcr-solutions/industry-assets/fsi/cloud-call-center-for-fsi/-/settings/integrations)
